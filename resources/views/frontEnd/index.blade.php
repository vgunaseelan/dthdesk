            ...
            <form   id="contactfrm" method="post" class="contact-form ">	
               ...
               <div class="ajaxmessage text-center" style="display:none;"></div>
                ...
                <div class="form-group">
                    <input name="name" id="name" placeholder="Name" type="text" class="contact-form-text form-control" required>
                </div>
                <div class="form-group">
                        <input name="email" id="email" placeholder="Email" type="text" class=" contact-form-text form-control" required>
                </div>
    
                <div class="form-group">
                    <input name="phone" id="phone" value="" size="40" aria-invalid="false" class="contact-form-text form-control" placeholder="Phone" type="text" required>
                </div>    
            
                <div class="form-group">
                        <input name="pincode" id="pincode" placeholder="Pincode" type="text" class= "contact-form-text form-control" required>
                </div>
    
                <div class="form-group">
                    <textarea name="comment" id="comment" aria-invalid="false" rows = '7' placeholder="Your message" class=" contact-form-text form-control" required></textarea>
                </div>
