                ...
                <form action="{{route('product.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('p_name')?' has-error':''}}">
                            ...
                            <span class="text-warning">{{$errors->first('p_name')}}</span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('old_price')?' has-error':''}}">
                            <div class="input-prepend"> <span class="add-on">$</span>
                                <input type="number" name="old_price" id="old_price" class="" value="{{old('old_price')}}" title="" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('p_code')?' has-error':''}}">
                            <input type="text" name="p_code" id="p_code" class="form-control" value="{{old('p_code')}}" title=""  style="width: 400px;">
