                                ...
                                <li>
                                    <form action="{{route('product_attr.store')}}" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="dimensions" value="{{old('dimensions')}}" id="dimensions" placeholder="Dimensions" >
                                            <!-- <input type="text" class="form-control" name="price" value="{{old('price')}}" id="price" placeholder="Price"  -->
                                            <!-- <span style="color: red;">{{$errors->first('price')}}</span> -->
                                            <input type="number" class="form-control" name="stock" value="{{old('stock')}}" id="stock" placeholder="Stock" >
                                        </div>
                        ...
                        <div class="widget-content nopadding">
                            <form action="{{route('product_attr.update',$product->id)}}" method="post" role="form">
                                ...
                                <tr>
                                    ...
                                    <td class="taskStatus">
                                        <input type="text" name="dimensions[]" id="dimensions" class="form-control" value="{{$attribute->dimensions}}" required="required" style="width: 75px;">
                                    </td>                                   
